...
sudo apt-get install bc zip libstdc++6 python gcc clang libssl-dev flex aria2 -y
...
git clone --depth 1 https://github.com/a20development/android_device_samsung_a20 -b fox-9.0 device/samsung/a20
mv device/samsung/a20/*.sh .
